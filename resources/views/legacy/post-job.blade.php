            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="navMenu" aria-labelledby="navMenuLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" id="navMenuList">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ route('employer.jobs.create') }}">Post Job</a></li>
                ...
                <div class="col-12 col-lg-10">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body p-5">
                            ...
                            <form id="jobPostForm" class="needs-validation" novalidate method="POST" action="{{ route('employer.jobs.store') }}">
                                @csrf
                                <input type="hidden" name="status" id="jobStatus" value="open">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="jobTitle" name="title" required value="{{ old('title') }}">
                                        <div class="invalid-feedback">Please provide a job title.</div>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="companyName" class="form-label">Company Name *</label>
                                        <input type="text" class="form-control" id="companyName" name="company_name" required value="{{ old('company_name', $user->company_name) }}">
                                        <div class="invalid-feedback">Please provide your company name.</div>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="location" class="form-label">Location *</label>
                                        <input type="text" class="form-control" id="location" name="location" placeholder="City, State or Remote" required value="{{ old('location') }}">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="jobType" name="employment_type" required>
                                            ...
                                            <option value="remote" @selected(old('employment_type')==='remote')>Remote</option>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="experienceLevel" name="experience_level" required>
                                            ...
                                            <option value="entry" @selected(old('experience_level')==='entry')>Entry Level (0-2 years)</option>
                                            <option value="mid" @selected(old('experience_level')==='mid')>Mid Level (3-5 years)</option>
                                            <option value="senior" @selected(old('experience_level')==='senior')>Senior Level (5+ years)</option>
                                            <option value="executive" @selected(old('experience_level')==='executive')>Executive Level</option>
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="salaryMin" name="salary_min" placeholder="50000" value="{{ old('salary_min') }}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="salaryMax" name="salary" placeholder="80000" value="{{ old('salary') }}">
                                        </div>
                                        <div class="form-text">We’ll store the maximum value if provided.</div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="requiredSkills" name="required_skills" placeholder="e.g., JavaScript, React, Node.js, SQL" required value="{{ old('required_skills') }}">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="preferredSkills" name="preferred_skills" placeholder="e.g., TypeScript, AWS, Docker" value="{{ old('preferred_skills') }}">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="jobDescription" class="form-label">Job Description *</label>
                                        <textarea class="form-control" id="jobDescription" name="description" rows="6" placeholder="Describe the role, responsibilities, and what you're looking for..." required>{{ old('description') }}</textarea>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="companyDescription" name="responsibilities" rows="3" placeholder="Tell candidates about your company culture...">{{ old('responsibilities', $user->company_name ? "{$user->company_name} is hiring!" : '') }}</textarea>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="companyWebsite" class="form-label">Company Website</label>
                                        <input type="url" class="form-control" id="companyWebsite" name="companyWebsite" placeholder="https://www.yourcompany.com" value="{{ old('companyWebsite') }}">
                                    </div>
                                    <div class="col-12 col-md-6 mb-3">
                                        <label for="contactEmail" class="form-label">Contact Email *</label>
                                        <input type="email" class="form-control" id="contactEmail" name="requirements" placeholder="hr@company.com" value="{{ old('requirements', $user->email) }}" required>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                @foreach (['Health Insurance', 'Dental Insurance', 'Vision Insurance', '401(k) / Retirement Plan'] as $benefit)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="{{ Str::slug($benefit) }}">
                                                        <label class="form-check-label" for="{{ Str::slug($benefit) }}">{{ $benefit }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                            <div class="col-12 col-md-6">
                                                @foreach (['Paid Time Off', 'Flexible Schedule', 'Remote Work Options', 'Professional Development'] as $benefit)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="{{ Str::slug($benefit) }}">
                                                        <label class="form-check-label" for="{{ Str::slug($benefit) }}">{{ $benefit }}</label>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg" id="postJobBtn">Post Job</button>
                                    </div>
                                </div>
                            </form>
                        </div>
